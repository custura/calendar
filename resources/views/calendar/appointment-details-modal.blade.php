<div
    ...
    <div class="fixed inset-0 transition-opacity" wire:click.stop="closeAppointmentDetailsModal">
    ...
    <div class="bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6"
        ...
        <div class="grid grid-cols-1 row-gap-6 col-gap-4 sm:grid-cols-6 mt-4">
            ...
            <div class="sm:col-span-6">
                ...
                <div class="mt-1 rounded-md shadow-sm">
                    ...
                    >{{ $selectedAppointment['notes'] }}</textarea>
                </div>
            </div>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-1 rounded-md shadow-sm">
                    <input
                        disabled
                        value="{{ $selectedAppointment['scheduled_at'] }}"
                        class="border rounded p-2 block w-full sm:text-sm sm:leading-5"
                        placeholder="What's the appointment about?"
                    />
                </div>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-1 rounded-md shadow-sm">
                    <input
                        disabled
                        value="{{ ucfirst($selectedAppointment['priority']) }}"
                        class="border rounded p-2 block w-full sm:text-sm sm:leading-5"
                        placeholder="What's the appointment about?"
                    />
                </div>
        ...
        <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
            <div class="flex w-full rounded-md shadow-sm sm:col-start-2">
                <button
                    type="button"
                    wire:click.stop="unscheduleAppointment"
            ...
            <div class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:col-start-1">
                <button
                    type="button"
                    wire:click.stop="closeAppointmentDetailsModal"
